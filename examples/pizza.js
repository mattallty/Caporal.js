...
program
  ...
  .option("-n, --number <num>", "Number of pizza", program.INT, 1)
  .option("-d, --discount <amount>", "Discount offer", program.FLOAT)
  ...
  .option("--add-ingredients <ingredients>", "Add extra ingredients", program.LIST)
