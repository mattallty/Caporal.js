...
class Autocomplete {
  ...
  _complete(data, done) {
    ...
    // const lastPartialIsArg = currCommand && lastPartIsOption === false && data.lastPartial !== currCommand.name()
    // const lastPartialIsKnownArg = this._lastPartialIsKnownArg(currCommand, lastPartialIsArg, lastPartial);
